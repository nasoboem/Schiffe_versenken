...
// Datum: 04.02.2019-07.02.2019; letzte Änderung: 26.04.2021
 ...
 * 
 *        Die Zeichen-Anweisungen aus gfx2 dürfen nebenläufig aufgerufen werden!
 *        ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
 *        --> Sollen bei Nebenläufigkeit mehrere Anweisungen "am Block" 
 *            ausgeführt werden, ist so vorzugehen:
 *        Sperren ()
 *        <Anweisungen aus gfx2>
 *        Entsperren () 
 */
 
// Vor.: Das Grafikfenster ist nicht offen. Es gilt: breite <=1920; hoehe <=1200.
//       Unter Linux bzw. Windows befindet sich das ausführbare Programm 'gfx2server'
//       bzw. 'gfx2server.exe' im Pfad. Der Port 'GfxPortnummer()' (Standard: 55555)
...
// Eff.: Das Serverprogramm 'gfx2server' bzw. 'gfx2server.exe' ist gestartet und
...
// Vor.: -
// Erg.: die Portnummer, die dem Serverprogramm 'gfx2server' bzw. 'gfx2server.exe'
//       zugewiesen wurde bzw. die es beim Start verwenden soll
// GfxPortnummer () uint16

// Vor.: Das Grafikfenster ist nicht offen, das Serverprogramm 'gfx2server' 
...
// Vor.: Das Grafikfenster ist offen.
// Eff.: Das Grafikfenster ist geschlossen. Das Serverprogramm 'gfx2server'
//       ist beendet. 
// FensterAus ()
 
// Vor.: Das Grafikfenster ist offen.
// Erg.: Die Anzahl der Grafikfensterzeilen (Pixelzeilen) des gfx2-Fensters
//       ist geliefert.
// Grafikzeilen () uint16
